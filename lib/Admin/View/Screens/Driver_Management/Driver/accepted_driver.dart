...
class AcceptedDriverWrapper extends StatelessWidget {
  const AcceptedDriverWrapper({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
      DriverblocBloc()..add(FetchDriver(searchQuery: null, status: "1")),
      child: AcceptedDriverPage(),
    );
  }
}

class AcceptedDriverPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
