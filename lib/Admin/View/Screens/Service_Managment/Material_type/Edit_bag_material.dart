...
class EditBagMaterial extends StatefulWidget {
  const EditBagMaterial({super.key});

  @override
  State<EditBagMaterial> createState() => _EditBagMaterialState();
}

class _EditBagMaterialState extends State<EditBagMaterial> {
