...
class ClothMaterialEdit extends StatefulWidget {
  const ClothMaterialEdit({super.key});

  @override
  State<ClothMaterialEdit> createState() => _ClothMaterialEditState();
}

class _ClothMaterialEditState extends State<ClothMaterialEdit> {
