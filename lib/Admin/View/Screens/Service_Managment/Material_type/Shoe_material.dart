...
import 'Add_shoe_material.dart';
import 'Edit_shoe_material.dart';

class ShoeMaterial extends StatefulWidget {
  const ShoeMaterial({super.key});

  @override
  State<ShoeMaterial> createState() => _ShoeMaterialState();
}

class _ShoeMaterialState extends State<ShoeMaterial> {
  List<Shoe_material> cloth = [
                                      ...
                                      builder: (context) {
                                        return AlertDialog(backgroundColor: Colors.white,
                                          ...
                                          content: SizedBox(
                                            ...
                                            child: EditShoesMaterial(), // Embedding ServiceEdit Widget
                                          ),
                                          actions: [
                                            TextButton(
                                              onPressed: () {
