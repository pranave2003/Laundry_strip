...
Widget buildServiceItemListShoe(List<Map<String, dynamic>> serviceItems,
    List<Map<String, dynamic>> selectedItems, Function updateSelectedItemsShoe) {
  return Expanded(
        ...
        return Card(
          ...
          child: ListTile(
                          ...
                          builder: (context, setState) {
                            return Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Image.asset("assets/Dress/sneaker.jpg",
                                        width: 50, height: 50),
                                    SizedBox(width: 10),
                                    Column(
                                      crossAxisAlignment:
            ...
            trailing: IconButton(
              ...
              onPressed: () {
                updateSelectedItemsShoe(serviceItems[index]);
              },
            ),
          ),
        );
