...
Widget buildServiceItemListBag(List<Map<String, dynamic>> serviceItems,
    List<Map<String, dynamic>> selectedItems, Function updateSelectedItemsBag) {
  return Expanded(
        ...
        return Card(
          ...
          child: ListTile(
                          ...
                          builder: (context, setState) {
                            return Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Image.asset("assets/Dress/carpet.png",
                                        width: 50, height: 50),
                                    SizedBox(width: 10),
                                    Column(
                                      crossAxisAlignment:
            ...
            trailing: IconButton(
              ...
              onPressed: () {
                updateSelectedItemsBag(serviceItems[index]);
              },
            ),
          ),
        );
