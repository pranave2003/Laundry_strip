...
class _ServiceState extends State<Service> {
  List<Map<String, dynamic>> serviceList = [
    {
      "icon": "assets/icon/wash_fold.png",
      "name": "Wash +\nFold",
    },
    {
      "icon": "assets/icon/wash_iron.png",
      "name": "Wash +\nIron",
    },
    {
      "icon": "assets/icon/steam_iron.png",
      "name": "Steam\nIron",
    },
    {
      "icon": "assets/icon/dry_clean.png",
      "name": "Dry\nClean",
    },
    {
      "icon": "assets/icon/bag_service.png",
      "name": "Bag\nServices",
    },
    {
      "icon": "assets/icon/shoe_service.png",
      "name": "Shoe Service",
    },
    {
    ...
    {
      "icon": "assets/icon/stain_removal.png",
      "name": "Stain Removal",
    },
  ];
